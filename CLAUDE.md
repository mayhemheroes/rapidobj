...
## Run Information
- Mayhem Run: mayhemheroes/rapidobj/rapidobj-fuzz/1
- Git Commit: 86f42e0203d018b9898e87504cd369143db5728d
- Original Image: ghcr.io/mayhemheroes/rapidobj:master
- Target Executable: ./rapidobj-fuzz
- CI URL: https://github.com:443/mayhemheroes/rapidobj//actions/runs/3941317649
...
- Source code: `/rlenv/source/rapidobj/`
...
Look at `mayhem/Dockerfile` and identify:
...
RUN cp <build-artifact> ./rapidobj-fuzz
...
- `COPY . /rlenv/source/rapidobj/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/rapidobj/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 ./rapidobj-fuzz`
...
- [ ] Target executable in Dockerfile.rlenv: `./rapidobj-fuzz`
- [ ] Target executable in build.sh: `./rapidobj-fuzz`
- [ ] Target executable in metadata.json: `./rapidobj-fuzz`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/rapidobj/` - EARLY (source exists now)
...
- Source copy: `COPY . /rlenv/source/rapidobj/`
...
- Working directory: `cd /rlenv/source/rapidobj/`
- No network access
